...
const partners = [
  { name: 'Restaurant', logo: '/client-1.png' },
  { name: 'Bakery', logo: '/client-2.png' },
  { name: 'Fork & Spoon', logo: '/client-3.png' },
  { name: 'Wolf Coffee', logo: '/client-4.png' },
  { name: 'Bistro', logo: '/client-5.png' },
  { name: 'Bakery', logo: '/client-6.png' },
]
